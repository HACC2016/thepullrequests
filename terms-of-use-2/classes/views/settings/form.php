    ...
    <form name="tou_settings_form" action="" method="post">
                    ...
                    <div class="submitbox">
                        <div id="minor-publishing">
                            ...
                            <div class="misc-pub-section" style="border:none;">	
                            	<p class="howto"><?php _e('Insert only summary on a page or post', 'terms_of_use') ?>:</p>
    	...
    	<table class="form-table">
            ...
            <tr>
				...
				<td>
				    ...
				    <div id="<?php echo user_can_richedit() ? 'postdivrich' : 'postdiv'; ?>" class="postarea">
            			<?php wp_editor(stripslashes($tou_settings->terms), 'terms'); ?>
            		</div>
            		</div>
            ...
            <tr class="form-field">
				...
				<td>
					<div id="<?php echo user_can_richedit() ? 'postdivrich' : 'postdiv'; ?>" class="postarea">
						<?php wp_editor(stripslashes($tou_settings->privacy_policy), 'privacy_policy'); ?>
         	...
         	<tr class="form-field">
				...
				<td>
					<div id="<?php echo user_can_richedit() ? 'postdivrich' : 'postdiv'; ?>" class="postarea">
						<?php wp_editor(stripslashes($tou_settings->welcome), 'welcome'); ?>
            		</div>
         	...
         	<tr class="form-field">
				...
				<td>
				    <textarea style="height:100px;" name="terms_error" id="terms_error" class="regular-text" ><?php echo esc_attr(stripslashes($tou_settings->terms_error)); ?></textarea>

                    <span class="description"><?php _e('Message seen when terms are required but not accepted.', 'terms_of_use') ?></span>

					<textarea style="height:100px;" name="initials_error" id="initials_error" class="regular-text" ><?php echo esc_attr(stripslashes($tou_settings->initials_error)); ?></textarea>
